...
const trackingGoogleClientId = process.env.WXT_PUBLIC_TRACKING_GOOGLE_CLIENT_ID?.trim();
const oauthScopes = [
  "https://www.googleapis.com/auth/gmail.modify",
  "https://www.googleapis.com/auth/gmail.settings.basic",
  "https://www.googleapis.com/auth/userinfo.email"
];
const trackingHostPermission =
  trackingApiBaseUrl && trackingGoogleClientId ? `${new URL(trackingApiBaseUrl).origin}/*` : undefined;
